        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center">
              ...
              />
              <span className="ml-2 text-lg font-semibold">StudentMarket</span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/category/Textbooks" className="text-base text-gray-300 hover:text-white">
                  Textbooks
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/category/Furniture" className="text-base text-gray-300 hover:text-white">
                  Furniture
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/category/Services" className="text-base text-gray-300 hover:text-white">
                  Services
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/create-product" className="text-base text-gray-300 hover:text-white">
                  Sell an Item
                </Link>
              </li>
              <li>
                <Link to="/wishlist" className="text-base text-gray-300 hover:text-white">
                  My Wishlist
                </Link>
              </li>
              <li>
                <Link to="/messages" className="text-base text-gray-300 hover:text-white">
                  Messages
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/orders" className="text-base text-gray-300 hover:text-white">
                  My Orders
                </Link>
              </li>
            </ul>
